...
export declare const mutateWithRepeated: (repeatCount: number, key: string, index: number) => {
    isRepeated: boolean;
    key: string;
    path: string;
} | {
...
export declare const itemsWithRepeat: (skeletons: (ISkeleton | IGrid | string)[], repeatCount: number) => any;
export declare const setOpacity: (viewIndex: number, repeatCount: number, rowsLength: number, withOpacity?: boolean) => number;
export declare const convertCssToReactStyles: (cssStyles: Record<string, any>) => Record<string, any>;
...
export declare const getGridStructure: (grid: IGrid | ISkeleton, gridState: Record<string, IGrid>, skeletonsState: Record<string, ISkeleton>, adaptiveDeviceEnabled: boolean) => Record<string, any>;
